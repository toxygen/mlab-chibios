 ...
 * Board identifier
 */
#define BOARD_stm32f107
#define BOARD_NAME              "MLAB STM32F107CxT01A"
...
#define GPIOB_LED_STATUS1       7
#define GPIOB_LED_STATUS2       9
 ...
 * PB8  - Push Pull output  (unconnected)
 * PB9  - Push Pull output  (LED1)
 * PB10 - Input with PU     (unconnected)
 * PB11 - Alternate output  (ETH_TX_EN)
...
#define VAL_GPIOBCRH            0x38BBB83B      /* PB15...PB8 */
 ...
 * PC6  - Push Pull output  (unconnected)
 * PC7  - Push Pull output  (unconnected)
